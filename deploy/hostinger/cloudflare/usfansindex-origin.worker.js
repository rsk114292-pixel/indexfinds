// Cloudflare service: usfansindex-net-production
// The public favicon wrapper keeps its ORIGIN service binding pointed here.
var worker_default = {
  fetch(request, env) {
    ...
    upstreamRequest.headers.set(
      ...
      env.HOSTINGER_TENANT_PROXY_SECRET,
    );
