...
const FeaturedBrandsSection = dynamic(() => import('@/components/home/FeaturedBrandsSection'));
const CategoriesBentoSection = dynamic(() => import('@/components/home/CategoriesBentoSection'));
...
export default function HomePageClient({
  ...
  if (viewport === 'mobile') {
    return <MobileHome initialCategories={initialCategories} />;
  }
