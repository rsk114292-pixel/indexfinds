...
export default function ItaobuyOfficialPromotion() {
  return (
    ...
    >
      ...
      >
        <span className="hidden rounded-full bg-white px-3 py-1 text-sm font-extrabold text-[#c2410c] sm:inline">
          Free
        </span>
        <span className="text-sm leading-5 sm:text-base">
          Daily 8kg/5kg Free Shipping - 7 Days in a Row!
        </span>
        <span className="shrink-0 rounded-full bg-white px-3 py-1 text-xs font-extrabold text-[#c2410c] sm:text-sm">
          Learn More
        </span>
      </a>
    </aside>
