...
import { Sparkles, Camera, Package, Crown } from 'lucide-react';
...
export default function HeroSection({ initialHotSearches }: HeroSectionProps) {
  ...
  const capabilityItems = [
    ...
    { icon: Package, label: t('hero.featureProducts', { count: '150000+' }) },
    { icon: Crown, label: t('hero.featureBrands', { count: '350+' }) },
  ];
    ...
    <section className="relative min-h-[460px] md:min-h-[520px] flex flex-col justify-center overflow-hidden bg-secondary">
      ...
      <div className="relative z-10 container mx-auto px-4 pt-12 pb-6 md:pt-20 md:pb-10">
        ...
        <FadeIn direction="down" duration={0.6}>
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-center mb-5 leading-tight tracking-tight">
            <span className="text-white">{t('hero.discover')}</span>
            <span
            ...
            <span className="text-white">{t('hero.fromChina')}</span>
          </h1>
        </FadeIn>
        ...
        <FadeIn direction="up" duration={0.5} delay={0.25}>
          <div ref={searchRef} className="relative mx-auto mb-4 w-full max-w-[920px]">
            <div
              aria-hidden
              ...
              style={{
                background: 'radial-gradient(circle, rgba(129,140,248,0.18) 0%, rgba(255,122,78,0.18) 38%, transparent 74%)',
              }}
            />
        ...
        <FadeIn direction="up" duration={0.35} delay={0.3}>
          <div className="mx-auto mb-3 flex max-w-[860px] flex-wrap justify-center gap-2">
        ...
        {/* Hot Searches */}
        <FadeIn direction="up" duration={0.4} delay={0.38}>
          <HotSearches
            limit={6}
            source="general"
