...
const TENANT_BRANDING: Partial<Record<string, TenantBranding>> = {
  ...
  "eastmallbuyindex.com": {
    ...
    accentColor: "#f4c675",
    seoTitle: "EastMallBuy Guide | QC Checks and Verified Product Shortlists",
    description:
      "Use EastMallBuy QC checks to remove incomplete product leads, reopen current sources and keep a focused shortlist with unresolved questions visible.",
  ...
  "kameymallindex.com": {
    ...
    accentColor: "#f6c44a",
    seoTitle: "KameyMall Guide | Product Search, QC and Shipping Research",
    description:
      "Research KameyMall product search, current sources, exact options, QC evidence, packaging and measured parcel inputs without treating an estimate as a final outcome.",
  ...
  "cssbuyindex.com": {
    ...
    accentColor: "#77c430",
    seoTitle: "CSSBuy Guide | Product Links, Warehouse and Forwarding",
    description:
      "Search CSSBuy product links, preserve the exact option and use current warehouse, receipt, parcel and destination evidence for forwarding research.",
  ...
  "litbuyindex.com": {
    ...
    accentColor: "#ffd400",
    seoTitle: "LitBuy Guide | Spreadsheet, Estimator and Warehouse Checks",
    description:
      "Search LitBuy spreadsheet links, group repeated results and keep estimator inputs, warehouse evidence, current sources and exact options in separate dated records.",
  ...
  "loongbuys.net": {
    ...
    accentColor: "#ffba52",
    seoTitle: "LoongBuy Guide | Shipping Estimates, QC and Product Links",
    description:
      "Review LoongBuy product links, warehouse QC evidence, measured parcel details and current route inputs before relying on a shipping estimate.",
  ...
  "superbuyindex.com": {
    ...
    accentColor: "#f29b38",
    seoTitle: "Superbuy Spreadsheet | Search and Refresh Product Links",
    description:
      "Search a Superbuy spreadsheet, group duplicate product links, reopen current sources and retain only rows with an exact option and dated review note.",
  ...
  "itaobuyindex.com": {
    ...
    accentColor: "#ffb44a",
    seoTitle: "iTaoBuy Guide | Product Links, Spreadsheet and QC Research",
    description:
      "Search iTaoBuy product links, preserve the exact option and separate seller details, warehouse QC evidence and measured parcel inputs before shipping research.",
