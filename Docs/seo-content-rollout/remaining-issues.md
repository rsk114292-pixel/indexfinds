...
- The original 2026-09-07 09:00 runs failed before work because the Codex usage limit was reached. A controlled rerun then produced two distinct results: the query monitor completed the primary 48-property group and observed `orientdig spreadsheet` newly at position 18.3 with three impressions, while the secondary 12-property group remained unread because that task lacked the secondary-account session. The index monitor could not attach to the browser at all under its task approval policy, so it recorded 0/60 completed and 60 pending without overwriting the 2026-09-06 verified states. This was not a Google 429 and is not evidence that any property disappeared.
